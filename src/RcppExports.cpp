...
BEGIN_RCPP
    ...
    add_cell_type(type_name, valence, temporal_modulation_bias, temporal_modulation_timeconstant, temporal_modulation_amplitude, transmission_velocity, coupling_scaling_factor, spine_density, axon_target, v_bound, dHdv_bound, I_spike, spike_potential, resting_potential, threshold, axon_branch_count, dendrite_branch_count, branch_independence, branch_spread, apical_target_layer);
    return R_NilValue;
END_RCPP
}
// modify_cell_type
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double& >::type branch_spread(branch_spreadSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type apical_target_layer(apical_target_layerSEXP);
    modify_cell_type(type_name, valence, temporal_modulation_bias, temporal_modulation_timeconstant, temporal_modulation_amplitude, transmission_velocity, coupling_scaling_factor, spine_density, axon_target, v_bound, dHdv_bound, I_spike, spike_potential, resting_potential, threshold, axon_branch_count, dendrite_branch_count, branch_independence, branch_spread, apical_target_layer);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_DACx_add_cell_type", (DL_FUNC) &_DACx_add_cell_type, 20},
    {"_DACx_modify_cell_type", (DL_FUNC) &_DACx_modify_cell_type, 20},
