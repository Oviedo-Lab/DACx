...
class network {
  ...
  public:
    ...
    MatrixXd                 neuron_temporal_modulation;    // n_neurons x 3 matrix giving the temporal modulation time (in unit_time) bias, step, and cutoff for each neuron in the network, based on its type
