...
The input current induced by synaptic transmission across all synapses, $I_\mathrm{synaptic\;transmission}$, is handled specially to account for signal transmission lag, as described in [the tutorial on spatial GT models](tutorial_SGT.html). However, the basic idea is straightforward: the synaptic current is the synaptic conductance times the presynaptic membrane potential $v$. 
